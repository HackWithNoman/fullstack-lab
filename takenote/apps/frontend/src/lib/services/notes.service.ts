...
const DEFAULT_NOTES: Note[] = [
  {
    ...
    content:
      "TakeNote is a premium note-taking space designed for quick capturing of thoughts. You can add, edit, search, filter, and color-code your notes. Try creating a new note to see it in action!",
    category: "general",
    color: "blue",
...
function saveToStore(notes: Note[]): void {
...
export const localStorageNotesService: NotesService = {
