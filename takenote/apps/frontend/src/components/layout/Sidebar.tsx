  ...
  return (
    <aside className="w-full md:w-64 shrink-0 flex flex-col gap-6">
      <div className="bg-white dark:bg-zinc-950 border border-zinc-200/50 dark:border-zinc-850/50 rounded-2xl p-5 shadow-2xs flex items-center gap-3.5 transition-all">
        ...
        <div>
          <h1 className="text-sm font-extrabold tracking-tight flex items-center gap-1.5 text-zinc-900 dark:text-zinc-100">
            TakeNote{" "}
            <span className="text-[8px] uppercase font-black px-1.5 py-0.5 rounded-md bg-zinc-100 dark:bg-zinc-855 border border-zinc-200/40 dark:border-zinc-700/40 text-zinc-600 dark:text-zinc-450 tracking-wider">
              Zen
            </span>
          </h1>
      ...
      <div className="bg-white dark:bg-zinc-950 border border-zinc-200/50 dark:border-zinc-850/50 rounded-2xl p-5 shadow-2xs flex flex-col gap-1.5">
        <h2 className="text-[9px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-widest px-1 mb-2.5">
          Categories
        </h2>
        ...
        <nav className="flex flex-col gap-1">
          {CATEGORIES.map((cat) => {
            ...
            const Icon =
              CATEGORY_ICON_MAP[cat.iconKey] || CATEGORY_ICON_MAP.all;
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3">
                  <span
                    className={`inline-flex items-center justify-center h-6 w-6 rounded-lg transition-colors duration-200 ${
                      isActive
                ...
                <span
                  className={`text-[10px] font-extrabold px-2 py-0.5 rounded-md transition-all ${
                    isActive
      ...
      <div className="hidden md:flex bg-white dark:bg-zinc-950 border border-zinc-200/50 dark:border-zinc-850/50 rounded-2xl p-5 shadow-2xs flex-col gap-2 relative overflow-hidden group">
        ...
        <p className="text-[11px] text-zinc-500 dark:text-zinc-450 italic leading-relaxed font-semibold">
          "Simplicity is the ultimate sophistication. Write things down to keep
          your mind clear."
        </p>
      </div>
    </aside>
