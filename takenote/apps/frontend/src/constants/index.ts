...
export const ZEN_COLORS = {
  slate: {
    ...
    badge: "bg-zinc-100 text-zinc-700 dark:bg-zinc-900 dark:text-zinc-400 border border-zinc-200/40 dark:border-zinc-800",
  },
  blue: {
    id: "blue",
    name: "Misty Clay",
    ...
    badge: "bg-blue-50 text-blue-700 dark:bg-[#15233c]/85 dark:text-blue-300 border border-blue-100/30 dark:border-blue-900/30",
  },
  emerald: {
    id: "emerald",
    name: "Earthy Sage",
    ...
    badge: "bg-emerald-50 text-emerald-700 dark:bg-[#112519]/85 dark:text-emerald-300 border border-emerald-100/30 dark:border-emerald-900/30",
  },
  amber: {
    id: "amber",
    ...
    badge: "bg-amber-50 text-amber-700 dark:bg-[#251b08]/85 dark:text-amber-300 border border-amber-100/30 dark:border-amber-900/30",
  },
  rose: {
    id: "rose",
    name: "Terracotta",
    ...
    badge: "bg-rose-50 text-rose-700 dark:bg-[#2e190e]/85 dark:text-rose-300 border border-rose-100/30 dark:border-rose-950/30",
  },
  violet: {
    id: "violet",
    name: "Lavender Mist",
    ...
    badge: "bg-indigo-50 text-indigo-700 dark:bg-[#191937]/85 dark:text-indigo-300 border border-indigo-100/30 dark:border-indigo-950/30",
  },
} as const;
